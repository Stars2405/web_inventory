...
<script type="text/javascript">
	...
	function sendDataPost() {
		...
		if ($titel == 'Form Edit Data Barang') {
			echo "var link = 'http://localhost/client_inventory/barang/update_action/'; ";
		} else {
			echo "var link = 'http://localhost/client_inventory/barang/create_action/'; ";
		}
		?>
		var dataForm = {};
	...
	function getDetail(id_barang) {
		var link = 'http://localhost/client_inventory/barang/detail?id_barang=' + id_barang;
	...
	function sendDataPost() {
		...
		if ($titel == 'Form Edit Data Barang') {
			echo "var link =
		'http://localhost/client_inventory/barang/update_action/';";
		} else {
			echo "var link =
		'http://localhost/client_inventory/barang/create_action/';";
		}
		?>
