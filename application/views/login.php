							...
							<div class="card-body">
								<form class="form-horizontal form-material" id="formLogin">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="email" placeholder="Masukkan Email" class="form-control form-control-line form-user-input" name="email" id="example-email">
										</div>
									</div>
								<div class="form-group">
...
<script type="text/javascript">
	...
	function checkLogin() {
		var link = "http://localhost/client_inventory/user/check_login/";
